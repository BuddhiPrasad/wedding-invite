        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-8">
            ...
            <div className="space-y-3">
              ...
              <h2 className="font-script text-4xl sm:text-6xl text-[#2D2D2D] leading-tight">
                A Celebration of <br />
                <span className="text-[#B08968]">Tradition & Love</span>
              </h2>

              <p className="font-serif italic text-base sm:text-lg text-[#7F5539]/90 leading-relaxed pt-2">
            ...
            <div className="space-y-6 pt-4">
              ...
              <div className="flex items-start gap-4">
                <div className="p-3 rounded-full bg-[#FAF8F5] border border-[#E3D4C1] text-[#B08968] shadow-sm shrink-0">
                  <Calendar className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="font-cinzel text-lg sm:text-xl font-medium text-[#2D2D2D]">
                    {weddingData.weddingDateFormatted}
                  </h4>
                  <p className="font-cinzel text-[10px] tracking-[0.2em] text-[#A67C52] uppercase mt-0.5">
          ...
          <div className="lg:col-span-6 flex justify-center">
            <div className="relative w-full max-w-[440px] aspect-[4/5] rounded-[36px] overflow-hidden bg-white p-3 border border-[#E3D4C1] shadow-card">
